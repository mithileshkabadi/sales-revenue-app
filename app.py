...
# Encode categorical inputs (convert to model-friendly format)
category_encoded = [1 if category == "Electronics" else 0, 1 if category == "Wearables" else 0]
region_encoded = [1 if region == "North" else 0, 1 if region == "South" else 0, 1 if region == "East" else 0]
shipping_status_encoded = [1 if shipping_status == "Delivered" else 0, 1 if shipping_status == "Returned" else 0]
